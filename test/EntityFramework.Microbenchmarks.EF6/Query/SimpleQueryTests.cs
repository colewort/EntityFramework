...
{
    public class SimpleQueryTests : IClassFixture<SimpleQueryTests.DatabaseFixture>
    {
        private readonly DatabaseFixture _databaseFixture;

        public SimpleQueryTests(DatabaseFixture databaseFixture)
        {
        ...
        public class DatabaseFixture
        {
            ...
            public string ConnectionString { get; } = $@"Server={BenchmarkConfig.Instance.BenchmarkDatabaseInstance};Database=Perf_Query_Simple_EF6;Integrated Security=True;MultipleActiveResultSets=true;";
        }
    }
}
