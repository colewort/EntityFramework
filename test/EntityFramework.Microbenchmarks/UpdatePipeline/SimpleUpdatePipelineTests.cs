...
{
    public class SimpleUpdatePipelineTests : IClassFixture<SimpleUpdatePipelineTests.DatabaseFixture>
    {
        private readonly DatabaseFixture _databaseFixture;

        public SimpleUpdatePipelineTests(DatabaseFixture databaseFixture)
        {
        ...
        {
            using (var context = new OrdersContext(_databaseFixture.ConnectionString, disableBatching))
            {
        ...
        public class DatabaseFixture
        {
            ...
            public string ConnectionString { get; } = $@"Server={BenchmarkConfig.Instance.BenchmarkDatabaseInstance};Database=Perf_UpdatePipeline_Simple;Integrated Security=True;MultipleActiveResultSets=true;";
        }
    }
}
