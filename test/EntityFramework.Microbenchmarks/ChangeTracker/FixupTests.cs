...
namespace EntityFramework.Microbenchmarks.ChangeTracker
{
    public class FixupTests : IClassFixture<FixupTests.DatabaseFixture>
    {
        ...
        public class DatabaseFixture
        {
            ...
            public string ConnectionString { get; } = $@"Server={BenchmarkConfig.Instance.BenchmarkDatabaseInstance};Database=Perf_ChangeTracker_Fixup;Integrated Security=True;MultipleActiveResultSets=true;";
        }
    }
}
